                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/db.Setting"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Update configuration success",
                        "schema": {
                            "$ref": "#/definitions/api.SuccessMessage"
                        }
                    },
    ...
    "definitions": {
        ...
        "db.Setting": {
            ...
            "properties": {
                ...
                "app_password": {
                    "description": "Platform email's app password",
                    "type": "string"
                },
                "checkin_url": {
                    "description": "The frontend URL of the checkin page",
                    "type": "string"
                },
                "email": {
                ...
                "max_workers": {
                    "description": "The total of background workers running in the background",
                    "type": "integer"
                },
                ...
                "secret_key": {
                    "description": "Platfrom secret key",
                    "type": "string"
                },
                "server_domain": {
                    "description": "Server domain, used for external API calling",
                    "type": "string"
                },
                "status": {
                    "type": "string"
